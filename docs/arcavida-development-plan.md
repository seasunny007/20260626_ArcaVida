...
| **核心能力** | 多源数据导入/抓取 -> 地址转坐标 -> 地图可视化 -> 置信度标注 -> 简报生成                |
...
| 救援协调需要标准化导出                                   | `exports/geojson.py`、`exports/unocha.py`           | P2     |
...
| OCHA 风格导出    | `exports/unocha.py`           | 字段映射清晰，标注非官方 |
...
| 标准化导出需要            | `exports/geojson.py`, `exports/unocha.py`           | Phase 5 |
